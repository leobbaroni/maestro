...
- Max 2–3 families; 2 is the practical ceiling. One family in 3–4 weights often beats two competing typefaces.
...
- ALL-CAPS and small-caps labels: add `letter-spacing: 0.05em`–`0.12em`. Large display text: default or slightly negative tracking.
...
- No horizontal scroll; no text below 14px on mobile; layout survives 200% zoom.
...
1. **Near-monochrome + one accent** — 90% of pixels from one hue's lightness ramp; one high-chroma accent ≤ 5–10% (CTA, live data). Safest path to "designed."
...
---
*Distilled from: impeccable, design-kit.*
