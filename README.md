...
skill and confirming skills/maestro/references contains 25 modules and skills/maestro/library
...
│   ├── references/              25 modules (design, page anatomy, commands, motion, 3D, video + shotcraft/sound, generative media, process, toolbox, companions)
