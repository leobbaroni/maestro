...
- **Video** — engine-neutral direction (story structure, beat planning, pacing, transitions); **product demo and promo film led by a 155-card shot vocabulary** with tuned reference implementations, a mode gate, and an eight-stage pipeline; dedicated engine modules for HyperFrames (HTML-to-video) and Remotion (React-to-video)
